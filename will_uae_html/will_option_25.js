...
export function get_will_option_25(data, pdf, isMirror)
{
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    ...
                    contained is made for the purpose only of settling my properties situated or arising in the<b> UNITED ARAB EMIRATES</b> and ${country} only. 
                    Any Wills made prior to this Will, relating to my estate in <b>UAE</b> and ${country} are now cancelled.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                ...
                <div class="small_title" style="${div_style+div_text_style}">
                    (a)	 To be shared equally between my ${children.length > 1 ? "CHILDREN" : "CHILD"}, namely:
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="${div_style+div_text_style}">
                    ${children_list}
                    absolutely and in the event of them not surviving me or failing to take a vested interest, then to their children as shall survive me to share equally among them if more than one.                             
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style+paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - text_title_size}px;` : `margin-left: ${text_title_size}px;`}">
                <div class="small_title" style="${div_style+div_small_title_style}">
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                ...
                I appoint  ${second_permanent_guardian_name} ,${permanent_guardian.nationality} Passport, with Passport No.${second_permanent_guardian_passport} , 
                ...
                to act as interim guardian of my ${children.length > 1 ? "CHILDREN" : "CHILD"} if any of them are under the age of full capacity at the time of my death.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            <div style="width: ${total_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                This interim guardianship appointment will apply until the permanent guardians will be able to act and take over the custody of my ${children.length > 1 ? "CHILDREN" : "CHILD"}.
                </div>
            </div>                
        </div>
    </div>
