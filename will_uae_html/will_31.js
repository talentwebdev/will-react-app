...
export function get_will_31(data)
{
    ...
    <p class="title" style="text-align: center; ${p_title_style}">
        <div style="text-align: center; ${p_title_style}">
            ...
            ${country} Citizen with Passport No. ${passport_number} and United Arab Emirates (UAE) Resident Card No. ${uae_id}, 
            Residing at ${address}, United Arab Emirates, in order to settle the succession of my estate upon my death do provide 
            as follows, namely:-
        </div> 
    </p>
    ...
    <div class="paragraph" style="${div_style+paragraph_style}" >
        <div style="display:flex; flex-direction: 'column'; ">
            I (FULL NAME OF CLIENT), born on the (DATE OF BIRTH), (COUNTRY) Citizen with
            Passport No. (PASSPORT NUMBER) and United Arab Emirates (UAE) Resident Card No.
            (UAE ID), Residing at (ADDRESS), United Arab Emirates, in order to settle the succession of
            my estate upon my death do provide as follows, namely:-
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="font-weight: bold; text-decoration: underline; ${div_style+div_text_style}">
                    ...
                    contained is made for the purpose only of settling my properties situated or arising in <b>the UNITED ARAB EMIRATES</b>  only. 
                    Any Wills made prior to this Will, relating to my estate in <b>UAE</b>   are now cancelled.
                </div>
            </div>                
        </div>
    </div>
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    I appoint ${executor_name}, born on the (DOB), residing at ${executor_address}, United Arab Emirates, 
                    holder of an ${executor_nationality} Passport with Passport Number ${executor_passport  } , 
                    and with United Arab Emirates (UAE) Resident Identity Card no. (UAE ID) ,to be my executor and trustee, 
                    but if (HE/SHE) is unable or unwilling to act or if (HE/SHE) dies before proving my Will, the following 
    ...
    <div class="paragraph" style="${div_style+paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - text_title_size}px;">
                <div class="small_title" style="${div_style}">
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                    ...
                    however informal they may be provided they are signed by me, dated after 
                    the date hereof and are clearly expressive of my intention, as to which my 
                    trustees shall be the sole judges. Any bequests so made shall be free of interest, 
                    delivery expenses and government taxes unless otherwise stipulated.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                I direct my trustees that all proceeds from any insurance policies shall be distributed according to 
                the existing nomination/beneficiary form filled up by me and in the absence of such form, the following 
                beneficiary provisions of this Will shall apply instead. 
                </div>
            </div>                
        </div>
    </div>
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                    ...
                    current and fixed deposits and any other accounts, motorcycles, motor cars, art and antiques, jewels, jewellery, 
                    furniture and fixtures, debentures, leasehold, bonds, security lockers, stocks, shares, investments, inheritances, 
                    mutual funds, capital, death in service benefits, gratuity payments, reserves, all insurance policies and any shareholding 
                    in any companies and any other assets in the following manner:-                 
                </div>
                <div class="small_title" style="${div_style+div_text_style}">
                    (a)	 To be shared equally between my (CHILD/CHILDREN), namely:
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                    (FIRST CHILDS NAME), born on the (DOB), holder of an (NATIONALITY) Passport, with Passport No. (PASSPORT NUMBER);
                    (SECOND CHILDS NAME), born on the (DOB), holder of an (NATIONALITY) Passport, with Passport No. (PASSPORT NUMBER);
                    (SECOND CHILDS NAME), born on the (DOB), holder of an (NATIONALITY) Passport, with Passport No. (PASSPORT NUMBER), absolutely and in the event of them not surviving me or failing to take a vested interest, then to their children as shall survive me to share equally among them if more than one.                             
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                    (b)	If any part of the residue of my estate falls to a beneficiary who has not attained the age of twenty-one (21) years, my trustees shall hold the same in trust for this beneficiary until the age of twenty-one (21) years is attained.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                    (c)	Income arising from such share shall be accumulated but my trustees may apply all or part of the income or capital of this share for the maintenance, education or benefit of this beneficiary.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                My trustees may appoint one or more executor of their own number to act as solicitor or agent in any other capacity and allow that trustee the same remuneration, as to which that trustee would have been entitled to.
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                Upon my demise, I appoint ${first_permanent_guardian_name}  to act as permanent guardian of my (CHILD/CHILDREN), 
                ...
                to act as interim guardian of my (CHILD/CHILDREN) and in the event of (HIM/HER) predeceasing me or being unable or unwilling to act, 
                I appoint ${second_temporary_guardian_name}, with United Arab Emirates (UAE) Resident Identity Card No. ${second_temporary_guardian_passport}, 
                to act as interim guardian of my (CHILD/CHILDREN) if any of them are under the age of full capacity at the time of my death.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            <div style="width: ${total_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                This interim guardianship appointment will apply until the permanent guardians will be able to act and take over the custody of my (CHILD/CHILDREN).
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            <div style="width: ${total_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                FINALLY: I declare that my country of domicile is ${country} and I am residing in the United Arab Emirates at the time of writing this Will.
                </div>
            </div>                
        </div>
    </div>
