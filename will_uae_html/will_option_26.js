...
export function get_will_option_26(data, pdf, isMirror)
{
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="${div_style+div_text_style}">
                    (b)	If any part of the residue of my estate falls to a 
                    beneficiary who has not attained the age of twenty-one (21) years, my trustees shall hold the same in trust for this beneficiary until 
                    the age of twenty-one (21) years is attained.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="${div_style+div_text_style}">
                    (c)	Income arising from such share shall be accumulated but my trustees 
                    may apply all or part of the income or capital of this share for the maintenance, 
                    education or benefit of this beneficiary.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            <div style="width: ${total_size}px;">
                <div class="small_title" style="${div_style+div_text_style}">
                    To pay over the same to the legal guardian or the person for the time being having the custody of that beneficiary, 
