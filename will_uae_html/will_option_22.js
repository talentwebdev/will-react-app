...
export function get_will_option_22(data, pdf, isMirror)
{
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    I appoint ${executor_name + " with " + executor_passport} to be my executor and trustee in relation to my UAE and ${country} Estates. In the event that
                      ${executor_name + " with " + executor_passport} predeceases me, then I appoint ${alternative_executor_name}, as the executor and Trustee in relation to my UAE and ${country} Estates.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        ...
        <div class="number" style="${div_style+div_number_style}"></div>
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size * 2}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    hold the residue of my UAE and ${country} Estates after payment of my debts, funeral and testamentary expenses, 
                    legacies, administrative fees and other liabilities on all property which vests in them (“my Residuary Estate”).  
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    The law and the Rules of the Dubai International Financial Centre (including the Wills and 
                    Probate Registry (WPR) Rules) govern the validity of this Will and its construction, effect and the administration of my Estate.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    The Courts of the Dubai International Financial Centre (as established under Dubai Law No. 12 of 2004) 
                    have exclusive jurisdiction in any proceedings involving rights or obligations under this Will or the administration of my Estate.
                </div>
            </div>                
        </div>
    </div>
