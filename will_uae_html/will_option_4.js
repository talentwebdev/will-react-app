...
export function get_will_option_4(data)
{
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="width: ${total_size - number_size}px;">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    I appoint my EXECUTOR, ${executor_name} to be my executor and trustee in relation to my UAE and ${country} Estates. In the event that
                    my ${executor_name} predeceases me, then I appoint ${alternative_executor_name}, as the Executor and Trustee in relation to my UAE and ${country} Estates.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div style="display:flex; flex-direction: 'row'; ">
        <div style="width: ${total_size}px;">
            <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                This Will, will be void if the Testator is a Muslim at any time before ${gender === "male" ? "HIS" : "HER"} death.            
            </div>
        </div>                
    </div>
</div>
