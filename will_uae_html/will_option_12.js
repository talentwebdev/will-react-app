...
export function get_will_option_12(data, pdf, isMirror)
{
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    ...
                    the purpose only of settling my properties situated or arising in the <b>UNITED ARAB EMIRATES</b> only. 
