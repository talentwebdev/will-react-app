...
export function get_will_option_30(data, pdf, isMirror)
{
    ...
    <div class="paragraph" style="${div_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                ...
                <div class="small_title" style="${div_style+div_text_style}">
                    (a)	 To be shared equally to namely: 
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="${div_style+div_text_style}">
                ${beneficiaries_list} 
                absolutely and in the event of them not surviving me or failing to take a vested interest, then to their children as shall 
    ...
    <div class="paragraph" style="${div_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="${div_style+div_text_style}">
                My trustees may appoint one or more executor of their own number to act as solicitor or agent in 
                any other capacity and allow that trustee the same remuneration, as to which that trustee would have been entitled to.
