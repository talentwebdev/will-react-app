...
export function get_will_option_21(data, pdf, isMirror)
{
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    ...
                    In the event that ${first_temporary_guardian_name + " " + second_temporary_guardian_name} predeceases me, then I appoint 
