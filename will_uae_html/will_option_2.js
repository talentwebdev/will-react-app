...
export function get_will_option_2(data, pdf, isMirror)
{
    ...
    const paragraph_style = "margin-top: 20px; page-break-inside: avoid;";
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    ...
                    my ${executor_name} predeceases me, then I appoint ${alternative_executor_name}, as the ${executor_name} and Trustee in relation to my UAE and ${country} Estates.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}" >
        ...
        <div class="number" style="${div_style+div_number_style}"></div>
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size * 2}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    hold the residue of my UAE and ${country} Estates after payment of my debts, funeral and testamentary expenses, legacies, administrative fees and other liabilities 
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    ...
                    govern the validity of this Will and its construction, effect and the administration of my Estate.
                </div>
            </div>                
        </div>
    </div>
        ...
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${total_size - number_size}px;` : `margin-left: ${number_size}px`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_text_style}">
                    ...
                    jurisdiction in any proceedings involving rights or obligations under this Will or the administration of my Estate.
                </div>
            </div>                
        </div>
    </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}; page-break-inside: avoid; " >
        <div style="display:flex; flex-direction: 'row'; ">
            <div style="${pdf === false ? `width: ${total_size * 0.4}px;` : `width: 40%;`}">
                <div class="small_title" style="font-weight: bold; ${div_style+div_test_name_style}">
                </div>
    ...
    <div class="paragraph" style="${div_style + paragraph_style}; page-break-inside: avoid; width: 100%; " >
