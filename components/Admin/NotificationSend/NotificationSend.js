...
class NotificaitonSend extends Component 
{
    ...
    onSelect = (index) => {
        ...
        this.props.navigation.navigate("NotificationSendDetailScreen", {
            id: items[index].id,
        ...
        return (
            <ImageBackground source={background} style={styles.background}>
                ...
                <View style={styles.toplogoContainer}>                    
                    <Image source={base_images.logo.small_image.source} style={[base_images.logo.small_image.style, {zIndex: 1000}]} ></Image>
                </View>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <TouchableOpacity style={styles.createButton} onPress={() => {this.props.navigation.navigate("NotificationCreateScreen")}}>
...
export default connect(mapStatesToProps)(NotificaitonSend);