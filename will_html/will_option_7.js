...
import {get_will_option_7_pdf} from "./will_option_7_pdf";

export function get_will_option_7(data, pdf)
{
    if(pdf) return get_will_option_7_pdf(data, pdf);
                    ...
                    <div style="display:flex; flex-direction: 'row'; ">
                        ...
                        <div style=" ${pdf === true ? `margin-left: ${number_size}px;` : `width: ${total_size - 2 * number_size}px;` }">
                            <div class="text" style="${div_style+div_text_style}">
                                ...
                                become possessed of, nothing excepted to ${children_name} in Equal shares.
                            </div>                 
                        </div>
                    </div>
                </div>
                        ...
                        <div style=" ${pdf === true ? `margin-left: ${number_size}px;` : `width: ${total_size - 2 * number_size}px;` }">
                            ...
                            <div class="paragraph" style="${div_style+paragraph_style}" >
                                <div style="display:flex; flex-direction: 'row'; ">
                                    ...
                                    <div style="${pdf === true ? `margin-left: ${number_size}px;` : `width: ${total_size - 3 * number_size}px; `}">
                                        <div class="text" style="${div_style+div_text_style}">                                
                                            I respectively hereby request that ${data[value_names.guard_appoint].name + " with " + data[value_names.guard_appoint].id_number} have dual signing powers and act in an
                    ...
                    <div style="display:flex; flex-direction: 'row'; ">
                        ...
                        <div style=" ${pdf === true ? `margin-left: ${number_size}px;` : `width: ${total_size - 2 * number_size}px;` }">
                            <div class="text" style="${div_style+div_text_style}">
                                ...
                                whole of my estate and effects whether movable or immovable,
    ...
    <div class="paragraph" style="${div_style+paragraph_style}" >
        <div style="display:flex; flex-direction: 'row'; ">
            ...
            <div style="${pdf === false ? `width: ${text_size}px;` : `margin-left: ${number_size}px;`} ">
                ...
                <div class="text" style="${div_style+div_text_style}">
                    I nominate ${data[value_names.guard_appoint].name + " with " + data[value_names.guard_appoint].id_number } as the guardian of MY minor children and failing his/her/their
                    acceptance thereto,I nominate ${data[value_names.another_guard_appoint].name + " with " + data[value_names.another_guard_appoint].id_number}.
                </div>
            </div>                
        </div>
    </div>
